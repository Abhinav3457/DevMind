      ...
      {open && (
        ...
        >
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-x-3 gap-y-1 border-t border-surface-700 px-4 py-2 text-[10px] text-surface-500">
              ...
              <span className="ml-auto hidden min-[420px]:inline">Ctrl K to open</span>
            </div>
          </motion.div>
        </motion.div>
      )}
