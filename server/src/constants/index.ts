...
export const PROJECT_STATUS = { ACTIVE: 'active', ARCHIVED: 'archived', DELETED: 'deleted' } as const;
export const AI_MODELS = { GEMINI_FLASH: 'gemini-2.5-flash', GEMINI_PRO: 'gemini-2.5-pro' } as const;
